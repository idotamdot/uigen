...
const STARTER_PROMPTS = [
  ...
  "Design a product card with an image and CTA button",
  "Make a responsive navbar with a mobile menu",
];
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-2 max-w-md">
            {STARTER_PROMPTS.map((prompt) => (
              <button
                ...
                className="px-3 py-1.5 text-sm rounded-full border border-neutral-200 bg-white text-neutral-700 shadow-sm transition-colors hover:border-blue-300 hover:bg-blue-50 hover:text-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2"
              >
                {prompt}
              </button>
            ))}
